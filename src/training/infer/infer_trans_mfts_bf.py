...
with torch.no_grad():
    for batch_idx, (mixed, clean_wav, traj_t, tgt_env_points, T60) in enumerate(tqdm(test_loader, desc='Test', ncols=100)):
        ...
        metric_dict['t60'].append(np.array(rec_t60).reshape(-1, 1))
...
plt.figure()
xs, ys, _ = get_xy(get_t60, get_snr, prec = 100)
...
plt.ylabel('SNR [dB]')
plt.legend()
plt.savefig('./figs/trans_snr-t60'+app+'.png')

# sisnr_iter = np.mean(get_sisnr, axis = 0)
# plt.figure()
# plt.plot(sisnr_iter)
# plt.ticklabel_format(style='plain')
# plt.title("sisnr")
# plt.savefig('./figs/trans_sisnr'+app+'.png')

# snr_iter = np.mean(get_snr, axis = 0)
# plt.figure()
# plt.plot(snr_iter)
# plt.ticklabel_format(style='plain')
# plt.title("snr")
# plt.savefig('./figs/trans_snr'+app+'.png')

# sdr_iter = np.mean(get_sdr, axis = 0)
# plt.figure()
# plt.plot(sdr_iter)
# plt.ticklabel_format(style='plain')
# plt.title("sdr")
# plt.savefig('./figs/trans_sdr'+app+'.png')

# wadp_iter = np.mean(get_wadp, axis = 0)
# plt.figure()
# plt.plot(wadp_iter)
# plt.ticklabel_format(style='plain')
# plt.title("wadp")
# plt.savefig('./figs/trans_wadp'+app+'.png')

# wadt_iter = np.mean(get_wadt, axis = 0)
# plt.figure()
# plt.plot(wadt_iter)
# plt.title("wadt")
# plt.savefig('./figs/trans_wadt'+app+'.png')


# xs, ys, _ = get_xy(loc_loss[:, :-1], get_sisnr, prec = 1000)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('sisnr-locloss')
# plt.savefig('./figs/a_check_IV_sisnr_loc_loss'+app+'.png')

# xs, ys, _ = get_xy(get_wadp[:, :-1], get_sisnr, prec = 100)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('sisnr-wadp')
# plt.savefig('./figs/a_check_IV_sisnr_wadp'+app+'.png')

# xs, ys, _ = get_xy(get_wadt[:, :-1], get_sisnr, prec = 100)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('sisnr-wadt')
# plt.savefig('./figs/a_check_IV_sisnr_wadt'+app+'.png')

# xs, ys, _ = get_xy(get_ad[:, :-1], get_sisnr, prec = 100)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('sisnr-ad')
# plt.savefig('./figs/a_check_IV_sisnr_ad'+app+'.png')

# xs, ys, _ = get_xy(get_norm_nmse[:, :1], get_wadt[:, :1], prec = 10)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('wadt-nmse')
# plt.savefig('./figs/a_check_IV_wadt_nmse'+app+'.png')


# xs, ys, _ = get_xy(get_norm_nmse[:, :1], get_wadp[:, :1], prec = 10)
# plt.figure()
# plt.plot(xs, ys)
# plt.ticklabel_format(style='plain')
# plt.title('wadp-nmse')
# plt.savefig('./figs/a_check_IV_wadp_nmse'+app+'.png')
